...
copy /v /y C:\development\xhcc\build\disco_production\device1\shared\platform\stm32\DISCO-Sorel-32F746GDISCOVERYv1r1-STM32-west-sdcard.bin    install_files\firmware.bin
copy /v /y C:\development\xhcc\build\disco_production\device1\shared\platform\stm32\langs.sd                                    data_files\langs.sd
copy /v /y C:\development\xhcc\web\teplomonitor-server\sitemenu.txt                                                 data_files\sitemenu.txt

SET dlparams=C:\development\xhcc\build\disco_production\device1\shared\platform\stm32\dlparams.sd
if exist %dlparams% (
...
del install_files\*.bin
copy /v /y C:\development\xhcc\build\disco_production\loader\shared\platform\stm32\loader-Sorel-32F746GDISCOVERYv1r1-STM32-sdcard.bin  install_files\bootldr.bin
