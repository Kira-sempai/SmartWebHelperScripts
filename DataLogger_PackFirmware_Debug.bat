...
copy /v /y C:\development\xhcc\build\DataLogger\device\shared\platform\stm32\DL-Sorel-L30vr1-STM32-sdcard.bin     install_files\firmware.bin
copy /v /y C:\development\xhcc\build\DataLogger\device\shared\platform\stm32\langs.sd                             data_files\langs.sd
copy /v /y C:\development\xhcc\web\teplomonitor-server\sitemenu.txt                                               data_files\sitemenu.txt

set dlparams=C:\development\xhcc\build\DataLogger\device\shared\platform\stm32\dlparams.sd
if exist %dlparams% (
...
del install_files\*.bin
copy /v /y C:\development\xhcc\build\DataLogger\loader\shared\platform\stm32\loader-Sorel-L30vr1-STM32-sdcard.bin         install_files\bootldr.bin
