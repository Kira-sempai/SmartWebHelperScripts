...
def getAvailableProjectsList():
	return [
		...
		Project('SW4', 'caleon_sw_base'  , 'Caleon Base'  , Device('SmartWeb-Caleon', 'rc50', 1, None, False, 'cubemx', 'stm32f7x.cfg'), 'rom', 'new', False, 'OID_HYDROLOGO'),
		Project('SW4', 'caleon_sw_clima' , 'Caleon Clima' , Device('SmartWeb-Caleon', 'rc50', 1, None, False, 'cubemx', 'stm32f7x.cfg'), 'rom', 'new', False, 'OID_HYDROLOGO'),
		Project('SW4', 'caleon_sw_master', 'Caleon Master', Device('SmartWeb-Caleon', 'rc50', 1, None, False, 'cubemx', 'stm32f7x.cfg'), 'rom', 'new', False, 'OID_HYDROLOGO'),
